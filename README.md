...
press of another button. There are two versions of the code at different stages. Written in Python and C. Code Written in Python was developed for Raspberry Pi 3. C was developed for the TI MSP432R microcontroller seen under "MicroProject". 
